...
print(f"La variable 01 es: {variable_01}")
...
print(f"Variable 03: {variable_03}")
...
print(f"Variable 04: {variable_04}")
...
print(f"Variable 05: {variable_05}")
...
print(f"Variable 06: {variable_06}")
